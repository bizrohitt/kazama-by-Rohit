...
class ReceiptPreview extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // `.value`, not `watch`: this preview is decorative and must not rebuild the
    // settings screen on every provider invalidation, and it must never sit on a
    // spinner (a settings page that is loading is a settings page nobody saves).
    final ticket = ref.watch(activeTicketProvider).value ??
